...
class QueryGenerator {
   ...
   */
  orderBy(fields) {
    fields.forEach(i => this.query.orderBy.push(
      fields[i][0] instanceof Fn ? fields[i][0].build() + ' ' + fields[i][1] : fields[i][0] + ' ' + fields[i][1]));
    return this;
  }
   ...
   */
  getQuery() {
    return this.getCreate() + ' ' + this.getSelect() + ' ' + this.getFrom() + ' ' + this.getJoin() + ' ' + this.getWhere() + ' ' + this.getGroupBy() + ' ' + this.getOrderBy() + ';';
  }
